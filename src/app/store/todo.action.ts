...
export enum TodoActionTypes {
    ...
    WE_UPDATE_TODO = 'WE_UPDATE_TODO',
    WE_UPDATE_TODO_SUCCEESS = 'WE_UPDATE_TODO_SUCCEESS',
    WE_UPDATE_TODO_FAILURE = 'WE_UPDATE_TODO_FAILURE',

    EW_TODO = 'EW_TODO',
    EW_TODO_SUCCEESS = 'EW_TODO_SUCCEESS',
    EW_TODO_FAILURE = 'EW_TODO_FAILURE',
