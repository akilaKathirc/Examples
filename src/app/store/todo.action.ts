...
export enum TodoActionTypes {
    ...
    DUMMY_FOR_GIT_TODO = 'DUMMY_FOR_GIT_TODO',
    DUMMY_FOR_GIT_TODO_SUCCEESS = 'DUMMY_FOR_GIT_TODO_SUCCEESS',
    DUMMY_FOR_GIT_TODO_FAILURE = 'DUMMY_FOR_GIT_TODO_FAILURE',

    SECOND_DUMMY_FOR_GIT_TODO = 'SECOND_DUMMY_FOR_GIT_TODO',
    SECOND_DUMMY_FOR_GIT_TODO_SUCCEESS = 'SECOND_DUMMY_FOR_GIT_TODO_SUCCEESS',
    SECOND_DUMMY_FOR_GIT_TODO_FAILURE = 'SECOND_DUMMY_FOR_GIT_TODO_FAILURE',

    THIRD_DUMMY_FOR_GIT_TODO = 'THIRD_DUMMY_FOR_GIT_TODO',
    THIRD_DUMMY_FOR_GIT_TODO_SUCCEESS = 'THIRD_DUMMY_FOR_GIT_TODO_SUCCEESS',
    THIRD_DUMMY_FOR_GIT_TODO_FAILURE = 'THIRD_DUMMY_FOR_GIT_TODO_FAILURE',
}
